...
@section('content')
    <div class="content">
        ...
        <main class="container flex-grow p-4 sm:p-6">
            ...
            <!-- Page Title Ends -->
            <!-- Add Discount Page Starts -->
            <form class="" id="myForm" action="{{ route('discount.store') }}" method="POST"
                        ...
                        <div class="rounded-primary bg-white p-6 shadow-sm dark:bg-slate-800">
                            ...
                            <div class="grid w-full grid-cols-1 gap-4 py-2 md:grid-cols-2">
                                <div class="flex w-full flex-col md:w-auto">
                                    ...
                                    <input name="discount" type="number" class="input" value="{{ old('discount') }}"
                                        required />
                                </div>
                                <div class="flex w-full flex-col md:w-auto">
                        ...
                        <div class="rounded-primary bg-white p-6 shadow-sm dark:bg-slate-800">
                            ...
                            <div class="grid w-full grid-cols-1 gap-4 py-2 md:grid-cols-2">
                                ...
                                <div class="flex w-full flex-col md:w-auto">
                                    ...
                                    <input name="max_uses" type="number" class="input" value="{{ old('max_uses') }}" />
                            ...
                            <div class="grid w-full grid-cols-1 gap-4 py-2 md:grid-cols-2">
                                <div class="flex w-full flex-col md:w-auto">
                                    ...
                                    <p class="help-text mt-1"> <input name="once_check" value="1" checked
