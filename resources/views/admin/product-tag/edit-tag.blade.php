                    ...
                    <section class="h-full lg:col-span-1">
                        ...
                        <div class="sticky top-20 rounded-primary bg-white p-6 shadow dark:bg-slate-800">
                            ...
                            <div class="flex flex-col gap-4">
                                ...
                                <div class="flex flex-col gap-4">
                                    <div>
                                        <label class="label  mb-1 font-medium" for="status"> Tag
                                        </label>
                                        <input type="text" name="name" class="input" id="name" value="{{$product_tag->name}}" />
                                    </div>
                                </div>
                                <div>
                                    ...
                                    <select name="status" class="select" id="status">
                                        <option value="0" {{ $product_tag->status == 0 ? 'selected' : '' }}>Draft</option>
                                            <option value="1" {{ $product_tag->status == 1 ? 'selected' : '' }}>Inactive</option>
                                            <option value="2" {{ $product_tag->status == 2 ? 'selected' : '' }}>Active</option>
                                    </select>
                                </div>
