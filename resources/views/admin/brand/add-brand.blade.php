            ...
            <section class="flex flex-col gap-8 lg:col-span-2">
                ...
                <div class="rounded-primary bg-white p-6 shadow-sm dark:bg-slate-800">
                    ...
                    <div class="py-2">
                        ...
                        <input type="text" class="input" id="name" value="Apple" />
                    </div>
                    <!-- <div class="py-2">
                        <label class="label label-required mb-1 font-medium" for="code">Brand Code
                        </label>
                    ...
                    <div class="py-2">
                        ...
                        <input type="text" class="input" id="name" value="" placeholder="Website Link" />
                    </div>
                </div>
                <!-- Pricing  -->
                <!-- <div class="rounded-primary bg-white p-6 shadow-sm dark:bg-slate-800">
                ...
                <div class="rounded-primary bg-white p-6 shadow-sm dark:bg-slate-800">
                    ...
                    <p class="mb-4 p-0 text-sm font-normal text-slate-400">
                        Show Brand with high-quality images
                    </p>
                    <div id="dropzone-Brand-edit" class="dropzone my-5">
            ...
            <section class="h-full lg:col-span-1">
                ...
                <div class="sticky top-20 rounded-primary bg-white p-6 shadow dark:bg-slate-800">
                    ...
                    <div class="flex flex-col gap-4">
                        ...
                        <!-- <div>
                            <label class="label  mb-1 font-medium" for="Brand">Parent
                                Brand
                            </label>
                        ...
                        <!-- <div>
                            <label class="label mb-1 font-medium" for="vendor"> Available Category </label>
                            <select class="tom-select" multiple="" autocomplete="off">
                                <option selected value="1">Watch</option>
