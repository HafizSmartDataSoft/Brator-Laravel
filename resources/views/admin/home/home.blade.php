            ...
            <div class="card">
              <div class="card-body">
                ...
                <div class="mt-4 flex items-center gap-4 rounded-primary bg-slate-50 p-4 dark:bg-slate-900">
                  <img
                    src="/adminAsset/images/product8.png"
                    alt="product-img"
            ...
            <div class="card">
              <div class="card-body flex flex-col gap-2">
                ...
                <div class="flex items-center gap-4 rounded-primary bg-slate-50 p-4 dark:bg-slate-900">
                  <img
                    src="/adminAsset/images/product7.png"
                    alt="product-img"
                    class="w-20 rounded-primary bg-white p-2 dark:bg-slate-800"
                  />
                  <div class="flex flex-1 flex-col gap-1">
                  ...
                  <tbody>
                      ...
                      <td>
                        <div class="flex items-center gap-2">
                          <div class="avatar avatar-circle">
                            <img src="/adminAsset/images/avatar1.png" class="avatar-img" alt="avatar-img" />
                          </div>
                          <div>
                    ...
                    <tr>
                      <td>
                        <div class="flex items-center gap-2">
                          <div class="avatar avatar-circle">
                            <img src="/adminAsset/images/avatar2.png" class="avatar-img" alt="avatar-img" />
                          </div>
                          <div>
                    ...
                    <tr>
                      <td>
                        <div class="flex items-center gap-2">
                          <div class="avatar avatar-circle">
                            <img src="/adminAsset/images/avatar3.png" class="avatar-img" alt="avatar-img" />
                          </div>
                          <div>
                    ...
                    <tr>
                      <td>
                        <div class="flex items-center gap-2">
                          <div class="avatar avatar-circle">
                            <img src="/adminAsset/images/avatar4.png" class="avatar-img" alt="avatar-img" />
                          </div>
                          <div>
                    ...
                    <tr>
                      <td>
                        <div class="flex items-center gap-2">
                          <div class="avatar avatar-circle">
                            <img src="/adminAsset/images/avatar5.png" class="avatar-img" alt="avatar-img" />
                          </div>
                          <div>
                  ...
                  <tbody>
                    <tr>
                      <td>
                        <div class="flex gap-2">
                          <div class="avatar avatar-circle">
                            <img src="/adminAsset/images/avatar1.png" alt="avatar-img" class="avatar-img" />
                          </div>
                          <div>
                    ...
                    <tr>
                      <td>
                        <div class="flex gap-2">
                          <div class="avatar avatar-circle">
                            <img src="/adminAsset/images/avatar2.png" alt="avatar-img" class="avatar-img" />
                          </div>
                          <div>
                    ...
                    <tr>
                      <td>
                        <div class="flex gap-2">
                          <div class="avatar avatar-circle">
                            <img src="/adminAsset/images/avatar3.png" alt="avatar-img" class="avatar-img" />
                          </div>
                          <div>
                    ...
                    <tr>
                      <td>
                        <div class="flex gap-2">
                          <div class="avatar avatar-circle">
                            <img src="/adminAsset/images/avatar4.png" alt="avatar-img" class="avatar-img" />
                          </div>
                          <div>
