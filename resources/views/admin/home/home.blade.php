                    ...
                    <div class="card">
                        <div class="card-body flex items-center gap-4">
                            <div
                                ...
                                <x-icon name="bx-dollar-circle" class="bx text-3xl"></x-icon>
                            </div>
                            <div class="flex flex-1 flex-col gap-1">
                    ...
                    <div class="card">
                        <div class="card-body flex items-center gap-4">
                            <div
                                ...
                                {{-- <x-icon name="ti-thumb-up" class="bx text-3xl"></x-icon> --}}
                                    ...
                                    <div id="store-analytics-chart-legend" class="flex items-center gap-4">
                                        <label for="visitors">
                                            ...
                                            <div class="flex items-center gap-1">
                                                ...
                                                <p class="text-sm font-medium text-slate-600 dark:text-slate-300">Visitors
                                                </p>
                                            </div>
                                        </label>
                                ...
                                <div class="dropdown" data-placement="bottom-end">
                                    ...
                                    <div class="dropdown-content w-[160px]">
                                        <ul class="dropdown-list">
                                            ...
                                            <li class="dropdown-list-item">
                                                <a href="javascript:void(0)" class="dropdown-link gap-2"> Another Action
                                                </a>
                                            </li>
                                        </ul>
                                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div
                                    ...
                                    <img src="/adminAsset/images/product8.png" alt="product-img"
                                    ...
                                    <div class="flex flex-1 flex-col gap-1">
                                        ...
                                        <div class="flex gap-1 text-xl text-warning-400">
                                            ...
                                            <x-icon name="bxs-star" class="bx text-3xl"></x-icon>
                                            <x-icon name="bxs-star" class="bx text-3xl"></x-icon>
                                            <x-icon name="bxs-star" class="bx text-3xl"></x-icon>
                                            <x-icon name="bxs-star" class="bx text-3xl"></x-icon>
                                            <x-icon name="bxs-star" class="bx text-3xl"></x-icon>
                        ...
                        <div class="card">
                            <div class="card-body flex flex-col gap-2">
                                ...
                                <div class="flex items-center gap-4 rounded-primary bg-slate-50 p-4 dark:bg-slate-900">
                                    <img src="/adminAsset/images/product7.png" alt="product-img"
                                        class="w-20 rounded-primary bg-white p-2 dark:bg-slate-800" />
                                    <div class="flex flex-1 flex-col gap-1">
                                        ...
                                        <div class="flex gap-1 text-xl text-warning-500">
                                            <x-icon name="bxs-star" class="bx"></x-icon>
                                            <x-icon name="bxs-star" class="bx"></x-icon>
                                            <x-icon name="bxs-star" class="bx"></x-icon>
                                            <x-icon name="bxs-star" class="bx"></x-icon>
                                            <x-icon name="bxs-star" class="bx"></x-icon>
                                    ...
                                    <tbody>
                                            ...
                                            <td>
                                                <div class="flex items-center gap-2">
                                                    <div class="avatar avatar-circle">
                                                        <img src="/adminAsset/images/avatar1.png" class="avatar-img"
                                                            alt="avatar-img" />
                                                    </div>
                                                    <div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="flex items-center gap-2">
                                                    <div class="avatar avatar-circle">
                                                        <img src="/adminAsset/images/avatar2.png" class="avatar-img"
                                                            alt="avatar-img" />
                                                    </div>
                                                    <div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="flex items-center gap-2">
                                                    <div class="avatar avatar-circle">
                                                        <img src="/adminAsset/images/avatar3.png" class="avatar-img"
                                                            alt="avatar-img" />
                                                    </div>
                                                    <div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="flex items-center gap-2">
                                                    <div class="avatar avatar-circle">
                                                        <img src="/adminAsset/images/avatar4.png" class="avatar-img"
                                                            alt="avatar-img" />
                                                    </div>
                                                    <div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="flex items-center gap-2">
                                                    <div class="avatar avatar-circle">
                                                        <img src="/adminAsset/images/avatar5.png" class="avatar-img"
                                                            alt="avatar-img" />
                                                    </div>
                                                    <div>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <div class="flex gap-2">
                                                    <div class="avatar avatar-circle">
                                                        <img src="/adminAsset/images/avatar1.png" alt="avatar-img"
                                                            class="avatar-img" />
                                                    </div>
                                                    <div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="flex gap-2">
                                                    <div class="avatar avatar-circle">
                                                        <img src="/adminAsset/images/avatar2.png" alt="avatar-img"
                                                            class="avatar-img" />
                                                    </div>
                                                    <div>
                                                        <p class="text-sm font-medium">Mehedi Hasan</p>
                                                        <p class="text-xs font-normal text-slate-400">mehedi@example.com
                                                        </p>
                                                    </div>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="flex gap-2">
                                                    <div class="avatar avatar-circle">
                                                        <img src="/adminAsset/images/avatar3.png" alt="avatar-img"
                                                            class="avatar-img" />
                                                    </div>
                                                    <div>
                                                        <p class="font-medium">Mirazul Islam</p>
                                                        <p class="text-xs font-normal text-slate-400">mirazul@example.com
                                                        </p>
                                                    </div>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="flex gap-2">
                                                    <div class="avatar avatar-circle">
                                                        <img src="/adminAsset/images/avatar4.png" alt="avatar-img"
                                                            class="avatar-img" />
                                                    </div>
                                                    <div>
                                                        <p class="font-medium">Tanvir Ahmed</p>
                                                        <p class="text-xs font-normal text-slate-400">tanvir@example.com
                                                        </p>
                                                    </div>
                                                </div>
                                            </td>
