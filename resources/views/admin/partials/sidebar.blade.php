    ...
    <ul class="sidebar-content">
      ...
      <li>
        ...
        <ul class="sidebar-submenu">
            ...
            <li>
              <a href="{{route('/add-category')}}" class="sidebar-submenu-item"> Add Category </a>
            </li>
            <li>
              <a href="{{route('/category-list')}}" class="sidebar-submenu-item"> Category List </a>
            </li>
            <li>
                <a href="{{route('/add-brand')}}" class="sidebar-submenu-item"> Add Brand </a>
              </li>

          <li>
            <a href="{{route('/add-product')}}" class="sidebar-submenu-item"> Add Product </a>
          </li>
          <li>
            <a href="{{route('/product-list')}}" class="sidebar-submenu-item"> Product List </a>
          </li>
