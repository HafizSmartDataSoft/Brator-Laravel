                ...
                <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
                    ...
                    <section class="flex flex-col gap-8 lg:col-span-2">
                        ...
                        <div class="rounded-primary bg-white p-6 shadow-sm dark:bg-slate-800">
                            ...
                            <div class="py-2">
                                <label class="label mb-1 font-medium" for="name">Review Title
                                </label>
                                <input type="text" name="title" class="input" id="name" value="{{$review->title}} " />
                            </div>
                            <div class="py-2">
                                <label class="label mb-1 font-medium"> Comment </label>
                                <textarea name="comment" class="textarea text-start" rows="5" placeholder="Write message"> {{$review->comment}} </textarea>
                            </div>
                        </div>
                    ...
                    <section class="h-full lg:col-span-1">
                        ...
                        <div class="sticky top-20 rounded-primary bg-white p-6 shadow dark:bg-slate-800">
                            <h5 class="m-0 p-0 text-xl font-semibold text-slate-700 dark:text-slate-200">
                                Organization</h5>
                            <p class="mb-4 p-0 text-sm font-normal text-slate-400">Better organize your Review</p>
