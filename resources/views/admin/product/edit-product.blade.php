      ...
      <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <section class="flex flex-col gap-8 lg:col-span-2">
          ...
          <div class="rounded-primary bg-white p-6 shadow-sm dark:bg-slate-800">
            ...
            <!-- <div class="py-2">
                                <label class="label label-required mb-1 font-medium" for="code">Product Code
                                </label>
        ...
        <section class="h-full lg:col-span-1">
          ...
          <div class="sticky top-20 rounded-primary bg-white p-6 shadow dark:bg-slate-800">
            ...
            <div class="flex flex-col gap-4">
              ...
              <div>
                <label class="label  mb-1 font-medium" for="Product">Parent
                  Category
                </label>
              ...
              <!-- <div>
                                    <label class="label mb-1 font-medium" for="Product"> Product </label>
                                    <select class="select" id="Product">
