                ...
                <div class="rounded-primary bg-white p-6 shadow-sm dark:bg-slate-800">
                    ...
                    <!-- <div class="grid w-full grid-cols-1 gap-4 py-2 md:grid-cols-2">
                        <div class="flex w-full flex-col md:w-auto">
                            ...
                            <input type="text" class="input" id="sku" value="01" />
                        </div>
                        <div class="flex w-full flex-col md:w-auto">
                            <label class="label mb-1 font-medium" for="sale-price"> Max Order QTY </label>
                            <input type="text" class="input" id="sale-price" value="10" />
                        </div>
                    </div> -->
                </div>
                <!-- Shipping  -->
                <!-- <div class="rounded-primary bg-white p-6 shadow-sm dark:bg-slate-800">
                    <h5 class="m-0 p-0 text-xl font-semibold text-slate-700 dark:text-slate-200">Shipping
                    </h5>
                    <label for="toggle-sm" class="toggle toggle-sm mb-4 mt-1">
                        <input class="toggle-input peer sr-only" id="toggle-sm" type="checkbox"
                            checked="" />
                    ...
                    <div class="grid w-full grid-cols-1 gap-4 py-2 md:grid-cols-2">
                        <div class="flex w-full flex-col md:w-auto">
                            <label class="label label-required mb-1 font-medium" for="weight"> Weight
                            </label>
            ...
            <section class="h-full lg:col-span-1">
                ...
                <div class="sticky top-20 rounded-primary bg-white p-6 shadow dark:bg-slate-800">
                    ...
                    <div class="flex flex-col gap-4">
                        ...
                        <div>
                            <label class="label label-required mb-1 font-medium" for="category"> Category
                            </label>
                            ...
                            <ul id="tree">
                                <li>
                                    <label class="label label-required mb-1 font-medium"><input type="checkbox" class="checkbox checkbox-primary parent-checkbox" data-id="1"> Electronics</label>
                                </li>
                                <li>
                                    <label class="label label-required mb-1 font-medium "><input type="checkbox" class="checkbox checkbox-primary parent-checkbox" data-id="2"> Body Parts</label>
                                </li>
                            </ul>
                        </div>
                        <div>
