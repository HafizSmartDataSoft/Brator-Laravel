                                ...
                                <tr>
                                            ...
                                            <div>
                                                ...
                                                <p class="truncate text-xs text-slate-500 dark:text-slate-400">
                                                    ...
                                                    @foreach ($sub_categories as $sub_category)
                                                        @if ($sub_category->product_id == $product->id)
                                                        @foreach ($categories as $category)
                                                        @if ($category->id == $sub_category->sub_category_id)
                                                            {{ $category->name }},
                                                        @endif
                                                    @endforeach
                                                        @endif
                                    ...
                                    <td>
                                        <div class="badge badge-soft-success">
                                            ...
                                            {{ $product->status == 1 ? 'Inactive' : '' }}
                                            {{ $product->status == 2 ? 'Active' : '' }}
                                            {{ $product->status == 3 ? 'Out Stock' : '' }}
                                    </td>
                                    <td>
                                            ...
                                            <div class="dropdown" data-placement="bottom-start">
                                                ...
                                                <div class="dropdown-content w-40">
                                                    <ul class="dropdown-list">
                                                        ...
                                                        <li class="dropdown-list-item">
                                                            <a href="{{ route('product.edit', ['product' => $product->sku]) }}"
                                                                class="dropdown-link">
                                                        ...
                                                        <li class="dropdown-list-item">
                                                            <a class="dropdown-link">
                                                                ...
                                                                <form
                                                                    action="{{ route('product.destroy', ['product' => $product->sku]) }}"
                                                                    method="post">
                                                                    @method('DELETE')
                                                                    @csrf
