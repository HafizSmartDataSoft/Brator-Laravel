            ...
            <tbody>
              <tr>
                ...
                <td>
                  <div class="flex items-center gap-3">
                    <img
                      src="{{asset('adminAsset')}}/images/product16.png"
                    ...
                    <div class="dropdown" data-placement="bottom-start">
                      ...
                      <div class="dropdown-content w-40">
                        <ul class="dropdown-list">
                          ...
                          <li class="dropdown-list-item">
                            <a href="{{route('/edit-product')}}" class="dropdown-link">
              ...
              <tr>
                ...
                <td>
                  <div class="flex items-center gap-3">
                    <img
                     src="{{asset('adminAsset')}}/images/product10.png"
                      class="h-10 w-10 rounded-primary border border-slate-300 dark:border-slate-400"
                      alt="product"
                    />
                    <div>
              ...
              <tr>
                ...
                <td>
                  <div class="flex items-center gap-3">
                    <img
                     src="{{asset('adminAsset')}}/images/product11.png"
                      class="h-10 w-10 rounded-primary border border-slate-300 dark:border-slate-400"
                      alt="product"
                    />
