            ...
            <div class="space-y-4">
                ...
                <div class="flex flex-col items-center justify-between gap-y-4 md:flex-row md:gap-y-0">
                    ...
                    <div class="flex w-full items-center justify-between gap-x-4 md:w-auto">
                                ...
                                <div class="dropdown-content w-72 !overflow-visible">
                                    <ul class="dropdown-list space-y-4 p-4">
                                        <li class="dropdown-list-item">
                                            <h2 class="my-1 text-sm font-medium"> Year</h2>
                        ...
                        <a class="btn btn-primary" href="{{ route('vehicle-year.create') }}" role="button">
                            <i data-feather="plus" height="1rem" width="1rem"></i>
                            <span class="hidden sm:inline-block">Add Year</span>
                        </a>
                    </div>
                    ...
                    <table class="table">
                        <thead>
                            <tr>
                                ...
                                <th class="w-[40%] uppercase"> Model name</th>
                                <th class="w-[40%] uppercase"> Year</th>
                            ...
                            @foreach ($vehicle_years as $vehicle_year)
                                <tr>
                                    ...
                                    @foreach ($vehicle_makes as $vehicle_make)
                                        @if ($vehicle_year->make_id == $vehicle_make->id)
                                            <td>
                                    ...
                                    @foreach ($vehicle_models as $vehicle_model)
                                        @if ($vehicle_year->model_id == $vehicle_model->id)
                                            <td>
                                                <div class="flex items-center gap-3">
                                                    <div>
                                                        <h6
                                    ...
                                    <td>
                                        <div class="badge badge-soft-success">
                                            {{ $vehicle_year->status == 0 ? 'Draft' : '' }}
                                            {{ $vehicle_year->status == 1 ? 'Inactive' : '' }}
                                            {{ $vehicle_year->status == 2 ? 'Active' : '' }}
                                    </td>
                                    <td>
                                                    ...
                                                    <ul class="dropdown-list">
                                                        ...
                                                        <li class="dropdown-list-item">
                                                            <a class="dropdown-link">
                                                                ...
                                                                <form
                                                                    action="{{ route('vehicle-year.destroy', ['vehicle_year' => $vehicle_year->id]) }}"
                                                                    method="post">
                                                                    @method('DELETE')
                                                                    @csrf
                                                                    <input type="hidden" value="{{ $vehicle_year->id }}"
                                                                        name="vehicle_year">
                                                                    <input type="submit" value="Delete"
                                                                        onclick="return confirm('Do you want to Delete vehicle_year !')">
                                                                </form>
                                                            </a>
                                                        </li>
                                                    </ul>
