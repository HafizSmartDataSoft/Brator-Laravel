              ...
              <tr>
                <th class="w-[5%]">
                  <input
                    ...
                    type="checkbox"
                    data-check-all
                    data-check-all-target=".Category-checkbox"
                  />
                </th>
            ...
            <tbody>
              <tr>
                ...
                <td>
                  <div class="flex items-center gap-3">
                    <img
                      src="{{asset('adminAsset')}}/images/Category16.png"
                    ...
                    <div class="dropdown" data-placement="bottom-start">
                      ...
                      <div class="dropdown-content w-40">
                        <ul class="dropdown-list">
                          ...
                          <li class="dropdown-list-item">
                            <a href="{{route('/edit-category')}}" class="dropdown-link">
              ...
              <tr>
                ...
                <td>
                  <div class="flex items-center gap-3">
                    <img
                     src="{{asset('adminAsset')}}/images/product4.png"
                      class="h-10 w-10 rounded-primary border border-slate-300 dark:border-slate-400"
                      alt="Category"
                    />
                    <div>
              ...
              <tr>
                ...
                <td>
                  <div class="flex items-center gap-3">
                    <img
                     src="{{asset('adminAsset')}}/images/product8.png"
                      class="h-10 w-10 rounded-primary border border-slate-300 dark:border-slate-400"
                      alt="Category"
                    />
                    <div>
              ...
              <tr>
                ...
                <td>
                  <div class="flex items-center gap-3">
                    <img
                     src="{{asset('adminAsset')}}/images/product9.png"
                      class="h-10 w-10 rounded-primary border border-slate-300 dark:border-slate-400"
                      alt="category"
                    />
              ...
              <tr>
                ...
                <td>
                  <div class="flex items-center gap-3">
                    <img
                     src="{{asset('adminAsset')}}/images/category10.png"
                      class="h-10 w-10 rounded-primary border border-slate-300 dark:border-slate-400"
                      alt="category"
                    />
                    <div>
              ...
              <tr>
                ...
                <td>
                  <div class="flex items-center gap-3">
                    <img
                     src="{{asset('adminAsset')}}/images/category11.png"
                      class="h-10 w-10 rounded-primary border border-slate-300 dark:border-slate-400"
                      alt="category"
                    />
              ...
              <tr>
                ...
                <td>
                  <div class="flex items-center gap-3">
                    <img
                     src="{{asset('adminAsset')}}/images/product12.png"
                      class="h-10 w-10 rounded-primary border border-slate-300 dark:border-slate-400"
                      alt="category"
                    />
              ...
              <tr>
                ...
                <td>
                  <div class="flex items-center gap-3">
                    <img
                     src="{{asset('adminAsset')}}/images/product13.png"
                      class="h-10 w-10 rounded-primary border border-slate-300 dark:border-slate-400"
                      alt="category"
                    />
              ...
              <tr>
                ...
                <td>
                  <div class="flex items-center gap-3">
                    <img
                     src="{{asset('adminAsset')}}/images/product14.png"
                      class="h-10 w-10 rounded-primary border border-slate-300 dark:border-slate-400"
                      alt="category"
                    />
