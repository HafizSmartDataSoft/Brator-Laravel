        ...
        <main class="container flex-grow p-4 sm:p-6">
            ...
            <div class="mb-6 flex flex-col justify-between gap-y-1 sm:flex-row sm:gap-y-0">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        <a href="#">Vehicle Model List</a>
                    </li>
                </ol>
            </div>
            <!-- Page Title Ends -->

            <!-- Vehicle Model  List Starts -->
            <div class="space-y-4">
                <!-- Vehicle model Header Starts -->
                <div class="flex flex-col items-center justify-between gap-y-4 md:flex-row md:gap-y-0">
                    ...
                    <div class="flex w-full items-center justify-between gap-x-4 md:w-auto">
                                ...
                                <div class="dropdown-content w-72 !overflow-visible">
                                    <ul class="dropdown-list space-y-4 p-4">
                                        <li class="dropdown-list-item">
                                            <h2 class="my-1 text-sm font-medium">Vehicle model</h2>
                        ...
                        <a class="btn btn-primary" href="{{ route('vehicle-model.create') }}" role="button">
                            <i data-feather="plus" height="1rem" width="1rem"></i>
                            <span class="hidden sm:inline-block"> ADD Vehicle Model </span>
                        </a>
                    </div>
                    <!-- Customer Action Ends -->
                </div>
                <!-- Vehicle Model  Header Ends -->

                <!-- Vehicle Model  Table Starts -->
                <div class="table-responsive whitespace-nowrap rounded-primary">
                    <table class="table">
                        <thead>
                            <tr>
                                <th class="w-[40%] uppercase">Sl No</th>
                                <th class="w-[40%] uppercase">Vehicle Model name</th>
                                <th class="w-[40%] uppercase">vehicle Make</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <p class="truncate text-xs text-slate-500 dark:text-slate-400">
                                            {{ Illuminate\Support\Str::limit($vehicle_model->description, $limit = 20, $end = '....') }}
                                            {{-- <a href="{{ route('vehicle_model.edit', ['id' => $vehicle_model->id]) }}">Read More</a> --}}
                                        </p>
                                    </td>
                                    ...
                                    <td>
                                        <div class="badge badge-soft-success">
                                            {{ $vehicle_model->status == 0 ? 'Draft' : '' }}
                                            {{ $vehicle_model->status == 1 ? 'Inactive' : '' }}
                                            {{ $vehicle_model->status == 2 ? 'Active' : '' }}
                                    </td>
                                    <td>
                                            ...
                                            <div class="dropdown" data-placement="bottom-start">
                                                ...
                                                <div class="dropdown-content w-40">
                                                    <ul class="dropdown-list">
                                                        ...
                                                        <li class="dropdown-list-item">
                                                            <a href="{{ route('vehicle-model.edit', ['vehicle_model' => $vehicle_model->id]) }}"
                                                                class="dropdown-link">
                                                        ...
                                                        <li class="dropdown-list-item">
                                                            <a class="dropdown-link">
                                                                ...
                                                                <form
                                                                    action="{{ route('vehicle-model.destroy', ['vehicle_model' => $vehicle_model->id]) }}"
                                                                    method="post">
                                                                    @method('DELETE')
                                                                    @csrf
                                                                    <input type="hidden" value="{{ $vehicle_model->id }}"
                                                                        name="vehicle_model">
                                                                    <input type="submit" value="Delete"
                                                                        onclick="return confirm('Do you want to Delete vehicle_model !')">
                                                                </form>
                                                            </a>
                                                        </li>
                                                    </ul>
                ...
                <!-- vehicle_model Table Ends -->

                <!-- vehicle_model Pagination Starts -->
                ...
                <!-- vehicle_model Pagination Ends -->
            </div>
            <!-- vehicle_model List Ends -->
        </main>
        <!-- Main Content Ends -->
