                    ...
                    <table class="table">
                        <thead>
                            <tr>
                                ...
                                <th class="w-[40%] uppercase">Customer name</th>
                                {{-- <th class="w-[40%] uppercase">Date of Birth</th> --}}
                                <th class="w-[10%] uppercase">Phone Number</th>
                                                        ...
                                                        <li class="dropdown-list-item">
                                                                ...
                                                                <form
                                                                    ...
                                                                    <input type="submit" value="Delete"
                                                                        onclick="return confirm('Do you want to Delete Customer !')">
                                                                    </a>
