            ...
            <div class="space-y-4">
                ...
                <div class="flex flex-col items-center justify-between gap-y-4 md:flex-row md:gap-y-0">
                    ...
                    <div class="flex w-full items-center justify-between gap-x-4 md:w-auto">
                                ...
                                <div class="dropdown-content w-72 !overflow-visible">
                                    <ul class="dropdown-list space-y-4 p-4">
                                        <li class="dropdown-list-item">
                                            <h2 class="my-1 text-sm font-medium">Engine Type</h2>
                        ...
                        <a class="btn btn-primary" href="{{ route('engine-type.create') }}" role="button">
                            <i data-feather="plus" height="1rem" width="1rem"></i>
                            <span class="hidden sm:inline-block">Add Engine </span>
                        </a>
                    </div>
                    ...
                    <table class="table">
                        <thead>
                            <tr>
                                ...
                                <th class="w-[40%] uppercase">Engine name</th>
                                <th class="w-[40%] uppercase">Engine Fuel</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <p class="truncate text-xs text-slate-500 dark:text-slate-400">
                                            {{ Illuminate\Support\Str::limit($engine_type->description, $limit = 20, $end = '....') }}
                                            {{-- <a href="{{ route('engine_type.edit', ['id' => $engine_type->id]) }}">Read More</a> --}}
                                        </p>
                                    </td>
                                    ...
                                    <td>
                                        <div class="badge badge-soft-success">
                                            {{ $engine_type->status == 0 ? 'Draft' : '' }}
                                            {{ $engine_type->status == 1 ? 'Inactive' : '' }}
                                            {{ $engine_type->status == 2 ? 'Active' : '' }}
                                    </td>
                                    <td>
                                            ...
                                            <div class="dropdown" data-placement="bottom-start">
                                                ...
                                                <div class="dropdown-content w-40">
                                                    <ul class="dropdown-list">
                                                        ...
                                                        <li class="dropdown-list-item">
                                                            <a href="{{ route('engine-type.edit', ['engine_type' => $engine_type->id]) }}"
                                                                class="dropdown-link">
                                                        ...
                                                        <li class="dropdown-list-item">
                                                            <a class="dropdown-link">
                                                                ...
                                                                <form
                                                                    action="{{ route('engine-type.destroy', ['engine_type' => $engine_type->id]) }}"
                                                                    method="post">
                                                                    @method('DELETE')
                                                                    @csrf
                                                                    <input type="hidden" value="{{ $engine_type->id }}"
                                                                        name="engine_type">
                                                                    <input type="submit" value="Delete"
                                                                        onclick="return confirm('Do you want to Delete engine_type !')">
                                                                </form>
                                                            </a>
                                                        </li>
                                                    </ul>
                ...
                <!-- engine_type Table Ends -->

                <!-- engine_type Pagination Starts -->
                ...
                <!-- engine_type Pagination Ends -->
            </div>
            <!-- engine_type List Ends -->
        </main>
        <!-- Main Content Ends -->
